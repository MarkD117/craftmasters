...
urlpatterns = [
    ...
    path('like/<slug:slug>/', views.ProjectLike.as_view(),
         name='project_like'),
    path('category/<str:cat_name>/', views.CategoryPage.as_view(),
         name='category'),
    path('add-project/', views.AddProject, name='add_project'),
    path('projects/<slug:slug>/edit/', views.UpdateProject,
         name='update_project'),
    path('projects/<slug:slug>/delete/', views.DeleteProject,
         name='delete_project'),
    path('drafts/', views.ProjectDrafts.as_view(), name='project_drafts'),
    path('unapproved-comments/', views.UnapprovedComments,
         name='unapproved_comments'),
    path('approve-comment/<int:comment_id>/', views.ApproveComment,
